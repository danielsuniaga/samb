...
class controller_get_data_analysis_iq_option_clean_another:
    ...
    def __init__(self):
        ...
        self.iq = case_iq_another.case_iq_another(cursor)
    ...
    def get_data_analysis_iq_option_clean_another(self,request):
