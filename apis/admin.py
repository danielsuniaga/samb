...
from .models import samb_apis, samb_cronjobs, samb_send_message_api_whatsapp, samb_platform, samb_financial_asset, samb_movements, samb_exceptions_apis, samb_notification_conditions, samb_movements_analysis, samb_api_financial_asset,samb_shedule,samb_config,samb_indicators
...
admin.site.register(samb_config)

admin.site.register(samb_indicators)
